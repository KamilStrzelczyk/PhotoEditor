...
public class ImageCropper extends JPanel {
    ...
    private int getHandle(Point p) {
        if (new Rectangle(cropRect.x, cropRect.y, HANDLE_SIZE, HANDLE_SIZE).contains(p)) return 0; // Lewy górny róg
        if (new Rectangle(cropRect.x + cropRect.width - HANDLE_SIZE, cropRect.y, HANDLE_SIZE, HANDLE_SIZE).contains(p)) return 1; // Prawy górny róg
        if (new Rectangle(cropRect.x + cropRect.width - HANDLE_SIZE, cropRect.y + cropRect.height - HANDLE_SIZE, HANDLE_SIZE, HANDLE_SIZE).contains(p)) return 2; // Prawy dolny róg
        if (new Rectangle(cropRect.x, cropRect.y + cropRect.height - HANDLE_SIZE, HANDLE_SIZE, HANDLE_SIZE).contains(p)) return 3; // Lewy dolny róg
        if (new Rectangle(cropRect.x + cropRect.width / 2 - HANDLE_SIZE / 2, cropRect.y, HANDLE_SIZE, HANDLE_SIZE).contains(p)) return 4; // Górna krawędź
        if (new Rectangle(cropRect.x, cropRect.y + cropRect.height / 2 - HANDLE_SIZE / 2, HANDLE_SIZE, HANDLE_SIZE).contains(p)) return 5; // Lewa krawędź
        if (new Rectangle(cropRect.x + cropRect.width - HANDLE_SIZE, cropRect.y + cropRect.height / 2 - HANDLE_SIZE / 2, HANDLE_SIZE, HANDLE_SIZE).contains(p)) return 6; // Prawa krawędź
        if (new Rectangle(cropRect.x + cropRect.width / 2 - HANDLE_SIZE / 2, cropRect.y + cropRect.height - HANDLE_SIZE, HANDLE_SIZE, HANDLE_SIZE).contains(p)) return 7; // Dolna krawędź
        return -1;
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.fillRect(cropRect.x + cropRect.width - HANDLE_SIZE, cropRect.y, HANDLE_SIZE, HANDLE_SIZE); // Prawy górny róg
        g.fillRect(cropRect.x + cropRect.width - HANDLE_SIZE, cropRect.y + cropRect.height - HANDLE_SIZE, HANDLE_SIZE, HANDLE_SIZE); // Prawy dolny róg
        g.fillRect(cropRect.x, cropRect.y + cropRect.height - HANDLE_SIZE, HANDLE_SIZE, HANDLE_SIZE); // Lewy dolny róg
        g.fillRect(cropRect.x + cropRect.width / 2 - HANDLE_SIZE / 2, cropRect.y, HANDLE_SIZE, HANDLE_SIZE); // Górna krawędź
        g.fillRect(cropRect.x, cropRect.y + cropRect.height / 2 - HANDLE_SIZE / 2, HANDLE_SIZE, HANDLE_SIZE); // Lewa krawędź
        g.fillRect(cropRect.x + cropRect.width - HANDLE_SIZE, cropRect.y + cropRect.height / 2 - HANDLE_SIZE / 2, HANDLE_SIZE, HANDLE_SIZE); // Prawa krawędź
        g.fillRect(cropRect.x + cropRect.width / 2 - HANDLE_SIZE / 2, cropRect.y + cropRect.height - HANDLE_SIZE, HANDLE_SIZE, HANDLE_SIZE); // Dolna krawędź
    }
